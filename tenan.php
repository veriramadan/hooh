...
if (strpos(json_encode($login), '"status":true')) {
    ...
    echo @color('green', "SING ENDI LORR: ");
    ...
    switch ($pilih) {
        ...
        default:
            echo @color('red', "PILIH PAKET SEK MASEE\n\n\n");
            goto cek;
            break;
    }
    $cek = cek($prodid);
    ...
    echo @color('purple', "LANJUT ORA LOR? (y/n) :");
    $aa = trim(fgets(STDIN));
    if(strtolower($aa) !== 'y') {
        goto cek;
    }
    ...
    if ($beli['status'] == true) {
        echo @color('green', "SUKSES TENAN\n");
    } else {
        echo @color('red', "GAGAL LOH ...!!! \n");
    }
